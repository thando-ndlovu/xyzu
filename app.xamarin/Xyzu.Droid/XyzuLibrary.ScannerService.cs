...
namespace Xyzu
{
	public sealed partial class XyzuLibrary : Java.Lang.Object, IServiceConnection
	{
		...
		[Service(
			...
			Name = "com.xyclonedesigns.xyzu.scannerservice",
		...
		public partial class ScannerService : Service
		{
			...
			{
				public const string Destroy = "com.xyclonedesigns.xyzu.scanner.action.DESTROY";
				public const string ScanHard = "com.xyclonedesigns.xyzu.scanner.action.SCAN_HARD";
				public const string ScanSoft = "com.xyclonedesigns.xyzu.scanner.action.SCAN_SOFT";
			}
