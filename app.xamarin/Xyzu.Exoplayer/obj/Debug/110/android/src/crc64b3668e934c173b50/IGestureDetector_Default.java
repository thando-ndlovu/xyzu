...
public class IGestureDetector_Default
...
/** @hide */
	...
	static {
		__md_methods = 
			"n_onContextClick:(Landroid/view/MotionEvent;)Z:GetOnContextClick_Landroid_view_MotionEvent_Handler\n" +
			...
			"";
		mono.android.Runtime.register ("Android.Views.IGestureDetector+Default, Xyzu.Extensions", IGestureDetector_Default.class, __md_methods);
	}


	public IGestureDetector_Default ()
	{
		super ();
		if (getClass () == IGestureDetector_Default.class)
			mono.android.TypeManager.Activate ("Android.Views.IGestureDetector+Default, Xyzu.Extensions", "", this, new java.lang.Object[] {  });
	}

	public IGestureDetector_Default (android.content.Context p0)
	{
		super ();
		if (getClass () == IGestureDetector_Default.class)
			mono.android.TypeManager.Activate ("Android.Views.IGestureDetector+Default, Xyzu.Extensions", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
